...
from chaco.api\
    import (AbstractDataSource, AbstractPlotData,
            ArrayDataSource, ArrayPlotData,
            DataView, DataRange1D, GridDataSource, GridMapper,
            Legend, ImagePlot, ImageData, CMapImagePlot,
...
class ChacoPlot2D(DataView):
    ...
    def __init__(self, data=None, **kwtraits):
        ...
        super(ChacoPlot2D, self).__init__(**kwtraits)
    ...
    def img_plot(self, data, name=None, colormap=None, xbounds=None,
                 ybounds=None, origin=None, hide_grids=True, **styles):
    ...
    def _create_2d_plot(self, cls, name, origin, xbounds, ybounds, value_ds,
        ...
        self.index = GridDataSource(xs, ys, sort_order=('ascending',
                                                        'ascending'))
    ...
    def delplot(self, *names):
        ...
        deleted_sources = set()
        for renderer in itertools.chain(*[self.plots.pop(name)
                                          for name in names]):
